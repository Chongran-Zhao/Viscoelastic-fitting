...
P_shear_list_2 = get_P_ij_list(1, 2, mu_eq, alpha_eq, mu_neq, alpha_neq, eta, Ft_2, time_2);
P_shear_list_3 = get_P_ij_list(1, 2, mu_eq, alpha_eq, mu_neq, alpha_neq, eta, Ft_3, time_3);
