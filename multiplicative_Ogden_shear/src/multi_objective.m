...
P_pre_1 = get_P_ij_list(1, 2, mu_eq, alpha_eq, mu_neq, alpha_neq, eta_list, Ft_1, time_1);
P_pre_2 = get_P_ij_list(1, 2, mu_eq, alpha_eq, mu_neq, alpha_neq, eta_list, Ft_2, time_2);
P_pre_3 = get_P_ij_list(1, 2, mu_eq, alpha_eq, mu_neq, alpha_neq, eta_list, Ft_3, time_3);
