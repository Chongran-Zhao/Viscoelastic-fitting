...
plot(ax, lambda1_exp(1:end-1), P1_exp(1:end-1), 'Color', '#ffa600', 'Marker', 'o', 'MarkerFaceColor', '#ffa600', 'MarkerSize', 12, 'LineStyle', 'none');
hold(ax, 'on');
plot(ax, lambda1_exp(1:end-1), P1_list(1:end-1), 'linewidth', 3.0, 'Color', '#ffa600', 'LineStyle', '-');
