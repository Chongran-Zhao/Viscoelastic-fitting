...
P_pre = get_P_ij_list(1, 2, mu_eq, alpha_eq, mu_neq, alpha_neq, eta, Ft, time);

switch mode
    case 1
        figure;
        ax = axes('Position', [0.1 0.5 0.8 0.4], 'Box', 'on');
        plot(ax, gamma(1:end-1), P_exp(1:end-1), 'Color', '#ffa600', 'Marker', 'o', 'MarkerFaceColor', '#ffa600', 'MarkerSize', 12, 'LineStyle', 'none');
        hold(ax, 'on');
