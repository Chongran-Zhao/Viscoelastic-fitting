...
data_1 = readmatrix('../exp-data/loading_2d5_unloading_0d05.xlsx');
P_exp_1 = data_1(:,3);
lambda_1 = data_1(:,2);

% No.2 shear experimental data
data_2 = readmatrix('../exp-data/loading_2d5_unloading_0d03.xlsx');
P_exp_2 = data_2(:,3);
lambda_2 = data_2(:,2);

% No.3 shear experimental data
data_3 = readmatrix('../exp-data/loading_2d5_unloading_0d01.xlsx');
P_exp_3 = data_3(:,3);
lambda_3 = data_3(:,2);
