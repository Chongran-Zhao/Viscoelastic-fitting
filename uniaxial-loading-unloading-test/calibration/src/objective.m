...
P_fit_1 = get_P_ij_list(1, 1, mu_eq, m_eq, n_eq, mu_neq, m_neq, n_neq, eta, Ft_1, time_1);
P_fit_2 = get_P_ij_list(1, 1, mu_eq, m_eq, n_eq, mu_neq, m_neq, n_neq, eta, Ft_2, time_2);
P_fit_3 = get_P_ij_list(1, 1, mu_eq, m_eq, n_eq, mu_neq, m_neq, n_neq, eta, Ft_3, time_3);
