...
hold(ax, 'on');
plot(ax, gamma_2(1:1:end), P_exp_2(1:1:end), 'Color', '#bc5090', 'Marker', 'o', 'MarkerFaceColor', '#bc5090', 'MarkerSize', 8, 'LineStyle', 'none');
hold(ax, 'on');
plot(ax, gamma_2(1:1:end), P_fit_2(1:1:end), 'linewidth', 3.0, 'Color', '#bc5090', 'LineStyle', '-');
hold(ax, 'on');
...
l = legend(ax, 'exp $\dot{\gamma}=5\:\mathrm{s}^{-1}$', 'fit $\dot{\gamma}=5\:\mathrm{s}^{-1}$',...
