...
gamma_3(:) = Ft_3(1,2,:);
gamma_4(:) = Ft_4(1,2,:);
P_pre_1 = get_P_ij_list(1, 2, mu_eq, m_eq, n_eq, mu_neq, m_neq, n_neq, eta_d, m, r, beta, Ft_1, time_1);
P_pre_2 = get_P_ij_list(1, 2, mu_eq, m_eq, n_eq, mu_neq, m_neq, n_neq, eta_d, m, r, beta, Ft_2, time_2);
P_pre_3 = get_P_ij_list(1, 2, mu_eq, m_eq, n_eq, mu_neq, m_neq, n_neq, eta_d, m, r, beta, Ft_3, time_3);
P_pre_4 = get_P_ij_list(1, 2, mu_eq, m_eq, n_eq, mu_neq, m_neq, n_neq, eta_d, m, r, beta, Ft_4, time_4);
out = zeros(size(Ft_1));
...
delta_y = 5;
% print R^2
R_square = (get_R_square(P_exp_1, P_pre_1) + get_R_square(P_exp_2, P_pre_2) + get_R_square(P_exp_3, P_pre_3) + get_R_square(P_exp_4, P_pre_4)) / 4.0;
...
NMAD = (get_NMAD(P_pre_1, P_exp_1) + get_NMAD(P_pre_2, P_exp_2) + get_NMAD(P_pre_3, P_exp_3) + get_NMAD(P_pre_4, P_exp_4)) / 4.0;
