...
[mu_eq, m_eq, n_eq, mu_neq, m_neq, n_neq, eta_d, zeta_infty, lota] = paras_to_array(paras, num_eq, num_neq);
P_pre = get_P_ij_list(1, 2, mu_eq, m_eq, n_eq, mu_neq, m_neq, n_neq, eta_d, zeta_infty, lota, Ft, time);
