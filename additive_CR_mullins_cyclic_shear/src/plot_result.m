...
P_pre = get_P_ij_list(1, 2, mu_eq, m_eq, n_eq, mu_neq, m_neq, n_neq, eta_d, zeta_infty, iota, Ft, time);
figure;
...
switch mode
    case 1
        ...
        x_location = 0.5;
        y_location = y_location + delta_y;
        text_zeta_infty = sprintf('$\\zeta_{\\infty} = %.4g$', zeta_infty);
        text(x_location, y_location, text_zeta_infty, ...
            'HorizontalAlignment', 'center', ...
            'VerticalAlignment', 'bottom', ...
            'Interpreter', 'latex', ...
            'FontSize', 25, 'FontWeight', 'bold', 'Color', 'k', 'FontName', 'Helvetica');
        x_location = x_location + delta_x;
        text_lota = sprintf('$\\iota = %.4g$', iota);
        text(x_location, y_location, text_lota, ...
            'HorizontalAlignment', 'center', ...
            'VerticalAlignment', 'bottom', ...
            'Interpreter', 'latex', ...
            'FontSize', 25, 'FontWeight', 'bold', 'Color', 'k', 'FontName', 'Helvetica');
