...
hold(ax, 'on');
plot(ax, gamma_1(1:1:end), P_pre_1(1:1:end), 'linewidth', 3.0, 'Color', '#003f5c', 'LineStyle', '-');
hold(ax, 'on');
...
hold(ax, 'on');
plot(ax, gamma_3(1:1:end), P_pre_3(1:1:end), 'linewidth', 3.0, 'Color', '#bc5090', 'LineStyle', '-');
hold(ax, 'on');
% plot(ax, gamma_4(1:10:end), P_exp_4(1:10:end), 'Color', 'r', 'Marker', 'o', 'MarkerFaceColor', 'r', 'MarkerSize', 8, 'LineStyle', 'none');
% hold(ax, 'on');
% plot(ax, gamma_4(1:10:end), P_pre_4(1:10:end), 'linewidth', 3.0, 'Color', 'r', 'LineStyle', '-');
% hold(ax, 'on');
...
R_square = (get_R_square(P_exp_1, P_pre_1) + get_R_square(P_exp_3, P_pre_3) ) / 2.0;
...
NMAD = (get_NMAD(P_pre_1, P_exp_1) + get_NMAD(P_pre_3, P_exp_3) ) / 2.0;
...
% print MSD
y_location = y_location + delta_y;
MSD = (get_MSD(P_pre_1, P_exp_1) + get_MSD(P_pre_2, P_exp_2)) / 2.0;
