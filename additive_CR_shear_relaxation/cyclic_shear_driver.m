...
% data_4 = readmatrix('~/Downloads/shear_relaxation_0d1.xlsx');
% time_4 = data_4(:,1);
% P_exp_4 = data_4(:,4);
% gamma_4 = data_4(:,5);
% 
...
objectiveFunction = @(paras) double_objective(paras, Ft_1, P_exp_1, time_1,...
                                Ft_3, P_exp_3, time_3,...
                                num_eq, num_neq);
...
plot_results(paras, num_eq, num_neq,...
                            ...
                            Ft_2, time_2, P_exp_2,...
                            Ft_3, time_3, P_exp_3);
print(gcf, '-djpeg', 'fig_shear_relaxation_validate.jpg');