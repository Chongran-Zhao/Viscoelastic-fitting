...
plot(ax, gamma(1:147), P_12(1:147), 'Color', '#ffa600', 'Marker', 'o', 'MarkerFaceColor', '#ffa600', 'MarkerSize', 5, 'LineStyle', '-', LineWidth=2.0);
hold on
plot(ax, gamma(148:350), P_12(148:350), 'Color', 'r', 'Marker', 'o', 'MarkerFaceColor', '#ffa600', 'MarkerSize', 5, 'LineStyle', '-', LineWidth=2.0);
hold on
plot(ax, gamma(350:end), P_12(350:end), 'Color', 'b', 'Marker', 'o', 'MarkerFaceColor', '#ffa600', 'MarkerSize', 5, 'LineStyle', '-', LineWidth=2.0);
