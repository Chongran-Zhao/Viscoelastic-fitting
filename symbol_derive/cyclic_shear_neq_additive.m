...
plot(ax, gamma(1:91), P_12(1:91), 'Color', '#ffa600', 'Marker', 'o', 'MarkerFaceColor', '#ffa600', 'MarkerSize', 5, 'LineStyle', '-', LineWidth=2.0);
hold on
plot(ax, gamma(92:202), P_12(92:202), 'Color', 'r', 'Marker', 'o', 'MarkerFaceColor', '#ffa600', 'MarkerSize', 5, 'LineStyle', '-', LineWidth=2.0);
hold on
plot(ax, gamma(203:328), P_12(203:328), 'Color', 'b', 'Marker', 'o', 'MarkerFaceColor', '#ffa600', 'MarkerSize', 5, 'LineStyle', '-', LineWidth=2.0);
hold on
plot(ax, gamma(329:end), P_12(329:end), 'Color', 'g', 'Marker', 'o', 'MarkerFaceColor', '#ffa600', 'MarkerSize', 5, 'LineStyle', '-', LineWidth=2.0);
