...
eig_val_S_eq = [eq_dPsi_dlambda(mu_eq, alpha_eq, lambda1) / lambda1;...
                eq_dPsi_dlambda(mu_eq, alpha_eq, lambda2) / lambda2;...
                eq_dPsi_dlambda(mu_eq, alpha_eq, lambda3) / lambda3];
