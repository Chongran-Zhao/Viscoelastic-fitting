...
plot(ax, gamma, P_exp, 'Color', '#58508d', 'Marker', 'o', 'MarkerFaceColor', '#58508d', 'MarkerSize', 8, 'LineStyle', 'none');
hold(ax, 'on');
plot(ax, gamma, P_pre, 'linewidth', 3.0, 'Color', '#58508d', 'LineStyle', '-');
...
l = legend(ax, ...
    'exp $\dot{\gamma}=0.1\:\mathrm{s}^{-1}$', 'fit $\dot{\gamma}=0.1\:\mathrm{s}^{-1}$',...
