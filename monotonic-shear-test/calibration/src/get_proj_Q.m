...
function out = get_proj_Q(m, n, lambda1, lambda2, lambda3, N1, N2, N3)
out = zeros(3,3,3,3);

e1 = get_scale_der(m, n, lambda1, 0);
e2 = get_scale_der(m, n, lambda2, 0);
e3 = get_scale_der(m, n, lambda3, 0);

e1_der = get_scale_der(m, n, lambda1, 1);
e2_der = get_scale_der(m, n, lambda2, 1);
e3_der = get_scale_der(m, n, lambda3, 1);
