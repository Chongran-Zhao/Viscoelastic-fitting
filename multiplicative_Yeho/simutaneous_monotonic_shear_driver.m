...
% xi_eq = [1.0e-3, 1.0e-3, 1.0e-3];
% xi_neq = [1.0e-3, 1.0e-3, 1.0e-3];
eta_d = 1000.0;

[paras0, lb, ub, num_eq, num_neq] = array_to_paras(xi_eq, xi_neq, eta_d);

% objectiveFunction = @(paras) objective(paras, Ft_2, P_shear_exp_2, time_2, num_eq, num_neq);
...
% paras0 = paras;
% 
% objectiveFunction = @(paras) double_objective(paras, Ft_2, P_shear_exp_2, time_2,...
