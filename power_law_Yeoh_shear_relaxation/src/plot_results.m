...
P_pre_1 = get_P_ij_list(1, 2, xi_eq, xi_neq, C1, C2, tau_hat, power_m, Ft_1, time_1);
P_pre_2 = get_P_ij_list(1, 2, xi_eq, xi_neq, C1, C2, tau_hat, power_m, Ft_2, time_2);
P_pre_3 = get_P_ij_list(1, 2, xi_eq, xi_neq, C1, C2, tau_hat, power_m, Ft_3, time_3);
