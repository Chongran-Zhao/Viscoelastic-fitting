function plot_result(paras, num_eq, num_neq, num_rel, time, lambda_exp, P_exp, mode)
close all;
...
P_pre = get_P_ij_list(1, 1, mu_eq, alpha_eq, mu_neq, alpha_neq, eta, Ft, time);
switch mode
    case 1
        figure;
        ax = axes('Position', [0.1 0.5 0.8 0.4], 'Box', 'on');
        plot(ax, lambda_exp, P_exp, 'Color', '#ffa600', 'Marker', 'o', 'MarkerFaceColor', '#ffa600', 'MarkerSize', 12, 'LineStyle', 'none');
        hold(ax, 'on');
        plot(ax, lambda_exp, P_pre, 'linewidth', 3.0, 'Color', '#ffa600', 'LineStyle', '-');
    ...
    case 0.1
        figure;
        ax = axes('Position', [0.1 0.5 0.8 0.4], 'Box', 'on');
        plot(ax, lambda_exp(1:20:end-1), P_exp(1:20:end-1), 'Color', '#ffa600', 'Marker', 'o', 'MarkerFaceColor', '#ffa600', 'MarkerSize', 12, 'LineStyle', 'none');
        hold(ax, 'on');
        plot(ax, lambda_exp(1:20:end-1), P_pre(1:20:end-1), 'linewidth', 3.0, 'Color', '#ffa600', 'LineStyle', '-');
        xlabel(ax, 'Stretch', 'interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold', 'FontName', 'Helvetica');
        ylabel(ax, 'Nominal stress', 'interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold', 'FontName', 'Helvetica');
        set(ax, 'TickDir', 'out', ...
            'TickLength', [.02 .02], ...
    ...
    case 0.3
        figure;
        ax = axes('Position', [0.1 0.5 0.8 0.4], 'Box', 'on');
        plot(ax, lambda_exp(1:10:end-1), P_exp(1:10:end-1), 'Color', '#ffa600', 'Marker', 'o', 'MarkerFaceColor', '#ffa600', 'MarkerSize', 12, 'LineStyle', 'none');
        hold(ax, 'on');
        plot(ax, lambda_exp(1:10:end-1), P_pre(1:10:end-1), 'linewidth', 3.0, 'Color', '#ffa600', 'LineStyle', '-');
        xlabel(ax, 'Stretch', 'interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold', 'FontName', 'Helvetica');
        ylabel(ax, 'Nominal stress', 'interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold', 'FontName', 'Helvetica');
        set(ax, 'TickDir', 'out', ...
            'TickLength', [.02 .02], ...
    ...
    case 0.6
        figure;
        ax = axes('Position', [0.1 0.5 0.8 0.4], 'Box', 'on');
        plot(ax, lambda_exp(1:3:end-1), P_exp(1:3:end-1), 'Color', '#ffa600', 'Marker', 'o', 'MarkerFaceColor', '#ffa600', 'MarkerSize', 12, 'LineStyle', 'none');
        hold(ax, 'on');
        plot(ax, lambda_exp(1:3:end-1), P_pre(1:3:end-1), 'linewidth', 3.0, 'Color', '#ffa600', 'LineStyle', '-');
        xlabel(ax, 'Stretch', 'interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold', 'FontName', 'Helvetica');
        ylabel(ax, 'Nominal stress', 'interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold', 'FontName', 'Helvetica');
        set(ax, 'TickDir', 'out', ...
            'TickLength', [.02 .02], ...
    ...
    case 0.03
        figure;
        ax = axes('Position', [0.1 0.5 0.8 0.4], 'Box', 'on');
        plot(ax, lambda_exp(1:100:end-1), P_exp(1:100:end-1), 'Color', '#ffa600', 'Marker', 'o', 'MarkerFaceColor', '#ffa600', 'MarkerSize', 12, 'LineStyle', 'none');
        hold(ax, 'on');
        plot(ax, lambda_exp(1:100:end-1), P_pre(1:100:end-1), 'linewidth', 3.0, 'Color', '#ffa600', 'LineStyle', '-');
        xlabel(ax, 'Stretch', 'interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold', 'FontName', 'Helvetica');
        ylabel(ax, 'Nominal stress', 'interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold', 'FontName', 'Helvetica');
        set(ax, 'TickDir', 'out', ...
            'TickLength', [.02 .02], ...
