...
P_shear_list_3 = get_P_ij_list(1, 2, mu_eq, alpha_eq, mu_neq, alpha_neq, eta_list, Ft_3, time_3);
...
for ii = 1:length(P_shear_exp3)
out = [out, P_shear_list_3(ii) - P_shear_exp3(ii)];
end
end